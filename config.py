...
# Optional. A Telegram photo file_id, obtained once via the hidden
# /getfileid utility. Powers the hidden /fed easter egg.
FED_PHOTO_FILE_ID = os.environ.get("FED_PHOTO_FILE_ID", "")
